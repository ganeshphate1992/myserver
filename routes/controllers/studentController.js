...
var { regStudentService, loginService, getStudentService, updateStudentService, deleteStudentService , getStdByIdService} = require('../services/studentService');
...
router.get("/get-std", 
    validateToken, async function (req, res, next) { // request received
    try{
...
// http://localhost:2020/std/delete-std, delete
router.delete(
    '/delete-std/:id',
    validateToken, async function (req, res, next) {
    try{
...
// http://localhost:2020/std/get-std-by-id, get
